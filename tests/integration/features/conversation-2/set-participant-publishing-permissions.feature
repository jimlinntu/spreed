Feature: set-participant-publishing-permissions
  Background:
  ...
  Scenario: owner can not set participant publishing permissions in one-to-one room
  ...
  Scenario: owner can set participant publishing permissions in group room
  ...
  Scenario: moderator can set participant publishing permissions in group room
    Given user "owner" creates room "group room" (v4)
      | roomType | 2 |
      | roomName | room |
    And user "owner" adds user "moderator" to room "group room" with 200 (v4)
  ...
  Scenario: others can not set participant publishing permissions in group room
    Given user "owner" creates room "group room" (v4)
      | roomType | 2 |
      | roomName | room |
    And user "owner" adds user "moderator" to room "group room" with 200 (v4)
  ...
  Scenario: owner can set participant publishing permissions in public room
  ...
  Scenario: moderator can set participant publishing permissions in public room
    Given user "owner" creates room "public room" (v4)
      | roomType | 3 |
      | roomName | room |
    And user "owner" adds user "moderator" to room "public room" with 200 (v4)
  ...
  Scenario: guest moderator can set participant publishing permissions in public room
    Given user "owner" creates room "public room" (v4)
      | roomType | 3 |
      | roomName | room |
    And user "owner" adds user "moderator" to room "public room" with 200 (v4)
  ...
  Scenario: others can not set participant publishing permissions in public room
    Given user "owner" creates room "public room" (v4)
      | roomType | 3 |
      | roomName | room |
    And user "owner" adds user "moderator" to room "public room" with 200 (v4)
  ...
  Scenario: participants can not set participant publishing permissions in room for a share
  ...
  Scenario: owner can set participant publishing permissions in a password request room
